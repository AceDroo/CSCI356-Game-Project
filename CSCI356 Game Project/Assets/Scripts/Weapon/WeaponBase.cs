...
public class WeaponBase : MonoBehaviour
{
	...
	void Start()
	{
		...
		weaponNameText = GameObject.Find("UI/GameUI/WeaponStatus/WeaponNameText").GetComponent<Text>();
		weaponAmmoText = GameObject.Find("UI/GameUI/WeaponStatus/AmmoText").GetComponent<Text>();
	}
